...
import com.sohaib.collageview.views.CollageView3Image0
import com.sohaib.collageview.views.CollageView3Image1
import com.sohaib.collageview.views.CollageView3Image2
import com.sohaib.collageview.views.CollageView3Image3
import com.sohaib.collageview.views.CollageView4Image0
import com.sohaib.collageview.views.CollageView4Image1
import com.sohaib.collageview.views.CollageView4Image2
import com.sohaib.collageview.views.CollageView4Image3
import com.sohaib.collageview.views.CollageView4Image4
import com.sohaib.collageview.views.CollageView6Image1
import com.sohaib.collageview.views.CollageViewHorizontal
import com.sohaib.collageview.views.CollageViewVertical
...
class CollageViewFactory(var context: Context, var attrs: AttributeSet?, var layoutWidth: Int, var layoutHeight: Int, var isBorderEnabled: Boolean, var imageUris: Array<Uri?>?) {
    ...
    fun getView(layoutType: CollageLayoutType): AbstractCollageView {
        return when (layoutType) {
            ...
            CollageLayoutType.SIX_IMAGE_1 -> CollageView6Image1(context, attrs, layoutWidth, layoutHeight, isBorderEnabled, imageUris)
        }
    }
