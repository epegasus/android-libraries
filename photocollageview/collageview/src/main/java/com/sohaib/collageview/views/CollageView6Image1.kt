...
class CollageView6Image1(
    ...
    override fun initImageLayout() {
        imageSizeAndPosCache[0] = ImageParams(layoutWidth / 3f, layoutHeight / 2f, 0f, 0f)
        imageSizeAndPosCache[1] = ImageParams(layoutWidth / 3f, layoutHeight / 2f, layoutWidth / 3f, 0f)
        imageSizeAndPosCache[2] = ImageParams(layoutWidth / 3f, layoutHeight / 2f, (layoutWidth / 3f)*2, 0f)
        imageSizeAndPosCache[3] = ImageParams(layoutWidth / 3f, layoutHeight / 2f, 0f, layoutHeight / 2f)
        imageSizeAndPosCache[4] = ImageParams(layoutWidth / 3f, layoutHeight / 2f, layoutWidth / 3f, layoutHeight / 2f)
        imageSizeAndPosCache[5] = ImageParams(layoutWidth / 3f, layoutHeight / 2f, (layoutWidth / 3f)*2, layoutHeight / 2f)
