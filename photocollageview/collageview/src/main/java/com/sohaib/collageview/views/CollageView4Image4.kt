...
class CollageView4Image4(context: Context, attrs: AttributeSet?, totalWidth: Int, totalHeight: Int, isBorderEnabled: Boolean = false, imageUris: Array<Uri?>? = null) :
    AbstractCollageView(context, attrs, 4, totalWidth, totalHeight, isBorderEnabled, imageUris), View.OnTouchListener {
