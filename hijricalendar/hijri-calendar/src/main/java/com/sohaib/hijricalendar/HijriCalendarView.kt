package com.sohaib.hijricalendar
...
import com.sohaib.hijricalendar.data.AndroidHijriDateConverter
import com.sohaib.hijricalendar.databinding.ViewHijriCalendarBinding
import com.sohaib.hijricalendar.domain.calendar.GenerateMonthCalendarUseCase
import com.sohaib.hijricalendar.presentation.adapter.pager.MonthPagerAdapter
import com.sohaib.hijricalendar.presentation.adapter.recyclerview.CalendarAdapter
import com.sohaib.hijricalendar.presentation.listener.HijriCalendarListener
import com.sohaib.hijricalendar.presentation.model.CalendarDayStyleConfig
import com.sohaib.hijricalendar.presentation.model.CalendarDayUiModel
import com.sohaib.hijricalendar.presentation.model.HijriCalendarHeader
import com.sohaib.hijricalendar.presentation.state.CalendarUiState
import com.sohaib.hijricalendar.presentation.viewmodel.CalendarViewModel
import com.sohaib.hijricalendar.presentation.viewmodel.CalendarViewModelFactory
...
class HijriCalendarView @JvmOverloads constructor(
    ...
    private var currentPagerPosition: Int = MonthPagerAdapter.Companion.INITIAL_POSITION
    ...
    init {
        ...
        val onSurface = MaterialColors.getColor(this, materialR.attr.colorOnSurface)
        val onSurfaceVariant = MaterialColors.getColor(this, materialR.attr.colorOnSurfaceVariant)
        ...
        binding.vpCalendarMonths.apply {
            ...
            registerOnPageChangeCallback(object : ViewPager2.OnPageChangeCallback() {
                override fun onPageSelected(position: Int) {
                    ...
                    val offset = position - MonthPagerAdapter.Companion.INITIAL_POSITION
    ...
    private fun initObserver() {
        ...
        lifecycleOwner.lifecycleScope.launch {
            viewModel.uiState.collectLatest { state ->
                ...
                val viewPagerRecyclerView = binding.vpCalendarMonths.getChildAt(0) as? RecyclerView
    ...
    private fun setupPreview() {
        ...
        binding.vpCalendarMonths.visibility = GONE
    ...
    fun setDate(date: LocalDate) {
        ...
        currentPagerPosition = MonthPagerAdapter.Companion.INITIAL_POSITION
    ...
    fun showHijriAdjustmentDialog(onApplied: ((HijriCalendarHeader) -> Unit)? = null) {
        ...
        MaterialAlertDialogBuilder(context)
            ...
            .setPositiveButton(R.string.dialog_adjust_hijri_save) { _, _ ->
                ...
                val offset = currentPagerPosition - MonthPagerAdapter.Companion.INITIAL_POSITION
                viewModel.setCurrentPage(offset)
